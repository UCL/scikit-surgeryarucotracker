...
===============================================
Requirements for scikit-surgerytracker
===============================================

This is the software requirements file for scikit-surgerytracker, part of the
SNAPPY project. The requirements listed below should define
what scikit-surgerytracker does. Each requirement can be matched to a unit test that
